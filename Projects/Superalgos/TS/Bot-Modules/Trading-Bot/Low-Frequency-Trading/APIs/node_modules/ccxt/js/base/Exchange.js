...
module.exports = class Exchange {
 ...
 this.setSandboxMode(true) //for binance TEST.api ( no real account needed! .. get free test.API.keys from: https://testnet.binance.vision )
//this.setSandboxMode(false) //for binance LIVE.api ( use for live trading with real binance account only )
